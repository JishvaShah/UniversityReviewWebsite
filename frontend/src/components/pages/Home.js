...
function Home() {
  return (
    <>
      <Helmet>
        <title>Home | University Rater</title>
      </Helmet>
        ...
        <div className="frame">
          <div className="section1">
            <p className="section1-text">
              ...
              <br />
              <br />
              We believe in the power of real and honest student experiences to
              guide you in making well-informed decisions about your academic
              future. Our platform is your one-stop destination to explore,
              evaluate, and share in-depth reviews of universities. Whether
              you&#39;re a prospective student or an alumnus, we&#39;ve got you
              covered.
            </p>
          </div>
