    ...
    if (like) {
      unlikeUni({ uerID: userId, uniID: university.id })
        .then((r) => {
          ...
          setLike(!like);
          setFavList((favList) =>
            favList.filter((item) => item !== university.id)
          );
          console.log("Remove a like");
        })
        .catch((e) => console.log(e));
    } else {
      // need to add the like to the list
  ...
  return (
    <div className="col">
      <div className="card mx-2">
        ...
        />
        <button
          className="btn btn-outline-primary wd-button wd-button-on-img"
        ...
        <div
          ...
          data-bs-target={`#modal-${university.id}`}
        >
          ...
          <p className="card-text">
            Popularity: &nbsp;
            <i className="fas fa-heart red-color" /> {popularity}
          </p>
        </div>

        <div
          className="modal fade"
          id={`modal-${university.id}`}
        ...
        >
          <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div className="modal-content">
              ...
              <img
                src={university.photo}
                className="card-img-top wd-card-img p-2"
                alt="sample"
              />
              <div className="modal-body">
                ...
                <p>
                  <span className="fw-bold">StudentSize: </span>
                  {university.studentSize}
                </p>
              </div>
        ...
        <div className="d-grid gap-2 d-md-flex justify-content-center m-2">
          ...
          <Link
            to={userId !== 0 ? `/addReviews/${university.id}` : "#"}
            onClick={(e) =>
              userId === 0 &&
              (alert("Please sign up/log in to write a review."), e.preventDefault())
            }>
